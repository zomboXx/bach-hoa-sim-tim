...
Ưu tiên: `P0` bắt buộc cho luồng quản lý; `P1` cần cho bản cuối kỳ; `P2` chỉ làm khi P0/P1 ổn định. Trạng thái phản ánh repository tại ngày 21/09/2026. TV1–TV4 được ánh xạ sang tên và GitHub trong [TEAM.md](TEAM.md).
...
|---|---|---:|---|---|---|---|
| GOV-01 | Chốt quy trình Scrum, phân công và DoD | P0 | TV1 | Cả nhóm | Review | Tài liệu trong `docs/project/governance` được nhóm điền tên và đồng ý |
...
Cập nhật triển khai: xem [bản giao kỹ thuật Sprint 1](../SPRINT_1.md). BE/FE/DB/QA đã có hiện thực để review trên nhánh `codex/sprint-1-foundation`; chưa tự đóng sprint. Chapter 0 Godot được đưa lên sớm; Chapter 1–6 vẫn placeholder, không đánh dấu TRN-02 của Sprint 4 đã hoàn tất.
