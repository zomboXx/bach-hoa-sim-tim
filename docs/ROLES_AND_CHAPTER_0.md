...
Nguồn sprite, cách tạo alpha và prompt xem [godot/ASSETS.md](../godot/ASSETS.md). Bản gốc giữ nguyên; file Web build sinh từ source, không phải game canvas tự viết trong PWA.
