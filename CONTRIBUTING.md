...
1. Cài Git, Node.js 22, Java 21, Maven, Docker và Godot 4.6.3 nếu sửa module tương ứng.
2. Clone repository, tạo nhánh từ `main`, sau đó chạy `pwsh -File scripts/setup.ps1`.
