...
Mở `http://127.0.0.1:5174`. API mặc định chạy ở `http://127.0.0.1:8080`; xem [`docs/project/SPRINT_1.md`](../../docs/project/SPRINT_1.md) để khởi động PostgreSQL, API và Godot Web export.
