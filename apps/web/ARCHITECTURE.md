...
Ngày cập nhật: 2026-09-21. Kiến trúc Sprint 1 đã được chốt tại [ADR 0002](../../docs/architecture/adr/0002-sprint-1-platform.md); năng lực và thời lượng từng thành viên vẫn cần xác nhận trong sprint planning.
...
- Backend Sprint 1: Java 21, Spring Boot 3.5, Security, Data JPA, PostgreSQL 17 và Flyway.
- Nguyễn Đức Phát: yêu cầu, contract, xác thực và tích hợp/review.
- Nguyễn Văn Trung: dữ liệu và API sản phẩm/danh mục/nhà cung cấp.
- Nguyễn Văn Thi: web adapter và trải nghiệm desktop/POS.
- Lê Văn Chiến: QA, responsive và traceability.

Mỗi phần API/CSDL cần ít nhất một owner và một reviewer theo [TEAM.md](../../docs/project/governance/TEAM.md). Thứ tự PR và tiêu chí bắt đầu nằm trong [Sprint 1 kickoff](../../docs/project/SPRINT_1_KICKOFF.md).
