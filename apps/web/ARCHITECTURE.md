...
Bản hiện tại đã có Spring Boot/PostgreSQL thật và Godot Chapter 0; contract hiện hành tại [OpenAPI](../../contracts/openapi.yaml), mô hình dữ liệu tại [DATA_MODEL.md](../../docs/architecture/DATA_MODEL.md), phạm vi tại [SPRINT_1.md](../../docs/project/SPRINT_1.md).
...
Mỗi phần API/CSDL có ít nhất một người phụ trách và một người review theo [TEAM.md](../../docs/project/governance/TEAM.md) để tránh chỉ một người hiểu hệ thống. Năng lực và thời lượng vẫn cần được xác nhận tại sprint planning.
